...
import { ErrorMessage, StyledForm } from './ReportForm.styled';
  ...
  return (
    <>
      <StyledForm onSubmit={handleSubmit(onSubmit)}>
        ...
        />
        {errors.email && (
          <ErrorMessage variant="caption">{errors.email.message}</ErrorMessage>
        )}
        ...
        {watch('reportType') === REPORT_TYPE.gambling && (
          <>
            <FormControl fullWidth variant="outlined">
              <InputLabel htmlFor="targetCountry">Choose a country</InputLabel>
              <Controller
                name="targetCountry"
                id="targetCountry"
                control={control}
        ...
        <Button type="submit" fullWidth variant="outlined" disabled={!isValid}>
          Send Report
        </Button>
      </StyledForm>
      <SnackBar
